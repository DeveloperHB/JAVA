...
<H2>이벤트 등록</H2>
<HR>
<form name=form1 method=post action=jdbctest1.jsp>
...
try{
	...
	String sql = "select userid, username, email, addr from jdbc_test1";
	...
	//마지막 데이터까지 반복함.
	while(rs.next()) {
		out.println(i+" : "+rs.getString(1)+", "+rs.getString(2)+" ," +rs.getString(3)+"," +rs.getString(4));
		i++;
	}
	//사용한 자원의 반납
	rs.close();
